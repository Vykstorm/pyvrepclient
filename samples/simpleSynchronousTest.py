...
if clientID!=-1:
    ...
    vrep_binds.simxSynchronous(clientID, True)

    # start the simulation:
    vrep_binds.simxStartSimulation(clientID, vrep_binds.simx_opmode_blocking)
    ...
    for i in range(1,10):
        ...
        vrep_binds.simxSynchronousTrigger(clientID);

    # stop the simulation:
    vrep_binds.simxStopSimulation(clientID, vrep_binds.simx_opmode_blocking)
